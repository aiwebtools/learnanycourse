        ...
        <AnimatedSection className="max-w-4xl mx-auto text-center">
          <GlassMorphism className="px-6 py-12 md:py-16">
            ...
            <h2 className="heading text-3xl md:text-4xl lg:text-5xl mb-6 text-gray-900">
              Master Any Course With AI-Guided Learning
            </h2>
            <p className="text-lg mx-auto mb-8 max-w-2xl text-gray-800 font-medium">
              Whether you want to learn history, mathematics, science, literature, or any other subject, Learn Any Course GPT provides personalized instruction with curated YouTube videos and visual aids.
            </p>
