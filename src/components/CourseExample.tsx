  ...
  return <section id="example" className="py-16 sm:py-24 relative overflow-hidden">
      ...
      <div className="section-container relative z-10 px-4 sm:px-6">
        <AnimatedSection className="text-center max-w-3xl mx-auto mb-10 sm:mb-16">
          <a href={CHATGPT_VERSION_URL} className="inline-block" aria-label="Open Learn Any Course GPT CHATGPT version">
              ...
              <div className="flex flex-col gap-3 sm:flex-row sm:justify-center">
                <Button size="lg" className="rounded-full px-6 sm:px-8 py-5 sm:py-6 text-sm sm:text-base font-semibold bg-primary text-white hover:bg-primary/90 w-full sm:w-auto" asChild>
                  <a href="#how-it-works" className="flex items-center justify-center">
                    Start Learning (INSITE version) <ArrowRight className="ml-2 h-4 w-4 sm:h-5 sm:w-5" />
                  </a>
                </Button>
                <Button size="lg" variant="outline" className="rounded-full px-6 sm:px-8 py-5 sm:py-6 text-sm sm:text-base font-semibold w-full sm:w-auto" asChild>
                  <a href={CHATGPT_VERSION_URL} target="_blank" rel="noopener noreferrer" className="flex items-center justify-center">
